...
- Don't repeat common values, use an existing CSS3 variable (or create a new one) in `app/frontend/styles/theme.css`.
- Use CSS3 variable features like `var()` to reference variables from `app/frontend/styles/theme.css`.
